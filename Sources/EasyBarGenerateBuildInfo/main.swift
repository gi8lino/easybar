...
private enum BuildInfoGeneratorError: Error, CustomStringConvertible, Sendable {
  ...
  var description: String {
    switch self {
    case .invalidArguments:
      return "usage: EasyBarGenerateBuildInfo <version-file> <output-file>"
    case .unreadableVersionFile(let path, let reason):
      return "failed to read EasyBar build version from \(path): \(reason)"
...
private enum EasyBarGenerateBuildInfo {
  ...
  static func run() throws {
    ...
    let source = """
      // Generated by EasyBarGenerateBuildInfo. Do not edit.
...
do {
  try EasyBarGenerateBuildInfo.run()
} catch {
